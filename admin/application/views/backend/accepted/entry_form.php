<?php
	$attributes = array( 'id' => 'accepteded-form', 'enctype' => 'multipart/form-data');
...
<section class="content animated fadeInRight">
  ...
  <div class="card card-info">
    ...
    <div class='d-flex justify-content-center'>
        <h1 ><span class='badge badge-danger'>Item # - <?= $accepted->item_no ?></span></h1>
    </div>
    <form role="form">
      <div class="card-body">
      	<div class="row">
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'title',
                'value' => set_value( 'title', empty(show_data( @$accepted->title))? 'No Title' :show_data( @$accepted->title)),
...
<!--Color-->
            ...
            <?php if ($accepted->manufacturer_id != "-2" && $accepted->color_id != null): ?>
...
<?php 
               ...
               $colorData = $this->db->get_where('bs_items_colors', array('status' => 1))->result();
                ...
                echo form_dropdown(
                  'color_value',
                  $options,
                  set_value( 'color_value', show_data( @$accepted->color_id), false ),
            ...
            //   )); 
             ...
             $transdata = $this->db->get_where('bs_items_transmissions', array('status' => 1)) ->result();
                ...
                echo form_dropdown(
                  'transmissions',
                  $options,
                  set_value( 'transmissions', show_data( @$accepted->transmission_id), false ),
                  'class="form-control form-control-sm mr-3"
                  id="transmissions"'
                );
            ...
            <?php if ($accepted->manufacturer_id != "-2"): ?>
            ...
            <div class="form-group">
              ...
              <?php
              if($accepted->manufacturer_id==-1){
                  echo "<br>";
                  echo "<p>" . $accepted->manufacturer_name . "</p>";
              } 
              else{
                  $options=array();
                $conds['status'] = 1;
                ...
                echo form_dropdown(
                  'manufacturer_id',
                  $options,
                  set_value( 'manufacturer_id', show_data( @$accepted->manufacturer_id), false ),
                  'class="form-control form-control-sm mr-3" 
            ...
            <div class="form-group">
              ...
              <?php
                if(isset($accepted)) {
                    if($accepted->model_id==-1){
                         echo "<br>";
                  echo "<p>" . $accepted->model_name . "</p>";
                    }else{
                        $options=array();
                   $options[0]=get_msg('select_model');
                  $conds['manufacturer_id'] = $accepted->manufacturer_id;
                  ...
                  echo form_dropdown(
                    'model_id',
                    $options,
                    set_value( 'model_id', show_data( @$accepted->model_id), false ),
        ...
        //   && $accepted->item_type_id != null
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_type_id',
                  $options,
                  set_value( 'item_type_id', show_data( @$accepted->item_type_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_location_id',
                  $options,
                  set_value( 'item_location_id', show_data( @$accepted->item_location_id), false ),
             ...
             <?php if ($accepted->description != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
              ...
              <?php echo form_textarea( array(
                'name' => 'description',
                'value' => set_value( 'description', show_data( @$accepted->description), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($accepted->highlight_info != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
              ...
              <?php echo form_textarea( array(
                'name' => 'highlight_info',
                'value' => set_value( 'info', show_data( @$accepted->highlight_info), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php   if( $accepted->package_detail){ ?>
              <div style="font-size:16px;"><?php

               $data_get =  json_decode(htmlspecialchars_decode($accepted->package_detail));
               if(!empty($data_get)){
        ...
        <input type="datetime-local" class="form-control" name="expiry_date" required value="<?php echo isset($accepted->expiry_date) ?
        // set_value(
        $accepted->expiry_date
        // , date('Y-m-d', strtotime($accepted->expiry_date)))
        : set_value('expiry_date'); ?>">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'price',
                'value' => set_value( 'price', show_data( @$accepted->price), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($accepted->engine_power != null || true): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
              ...
              <?php echo form_input( array(
                'name' => 'power',
                'value' => set_value( 'power', show_data( @$accepted->engine_power), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($accepted->item_price_type_id != null  || true): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_price_type_id',
                  $options,
                  set_value( 'item_price_type_id', show_data( @$accepted->item_price_type_id), false ),
            ...
            <?php if ($accepted->item_currency_id != null || true): ?>
            <!-- <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_currency_id',
                  $options,
                  set_value( 'item_currency_id', show_data( @$accepted->item_currency_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  ...
                  $options,
                  set_value( 'condition_of_item_id', show_data( @$accepted->condition_of_item_id), false ),
            ...
            <?php if ($accepted->plate_number != null || true): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
                Number Plate
              </label>
              ...
              <?php echo form_input( array(
                'name' => 'plate_number',
                'value' => set_value( 'plate_number', show_data( @$accepted->plate_number), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'mileage',
                'value' => set_value( 'mileage', show_data( @$accepted->mileage), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($accepted->fuel_type_id != null || true): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
               Fuel Type
              </label>
              <?php
            //  $data = $this->db->get_where('bs_items_fuel_types', array('id' => $accepted->fuel_type_id)) ->result();
              ...
              <?php 
               ...
               $options=array();;
                ...
                echo form_dropdown(
                  'fuel_type_id',
                  $options,
                  set_value( 'fuel_type_id', show_data( @$accepted->fuel_type_id), false ),
            ...
            <div class="form-group">
              ...
              echo form_input( array(
                'name' => 'sell_type',
                'value' => set_value( 'sell_type', show_data( @$accepted->sell_type), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($accepted->manufacturer_id != "-2" && $accepted->year != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
                Year
              </label>
              ...
              <?php echo form_input( array(
                'name' => 'year',
                'value' => set_value( 'year', show_data( @$accepted->year), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($accepted->manufacturer_id == "-2" && $accepted->service_area != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
                Service Area:
              </label>

                <p><?php echo $accepted->service_area; ?></p>
          ...
          <!-- <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'brand',
                'value' => set_value( 'brand', show_data( @$accepted->brand), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php   if( $accepted->phone_number){ ?>
              <h2 style="color:red;"><?php  echo  $accepted->phone_number ?></h2>
               <?php  }else{ ?>
                <h3 style="color:red;">Not Avialable</h3>
               <?php } ?>
            </div>
        ...
        <?php if ($accepted->manufacturer_id != "-2"): ?>
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                <?php echo form_checkbox( array(
                  ...
                  'id' => 'business_mode',
                  'value' => 'accept',
                  'checked' => set_checkbox('business_mode', 1, ( @$accepted->business_mode == 1 )? true: false ),
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                <?php echo form_checkbox( array(
                  ...
                  'id' => 'is_sold_out',
                  'value' => 'accept',
                  'checked' => set_checkbox('is_sold_out', 1, ( @$accepted->is_sold_out == 1 )? true: false ),
                  'class' => 'form-check-input',
                  'onclick' => 'return false'
                )); ?>
          ...
          <?php endif ?>
            ...
            <?php if ($accepted->address != null || true): ?>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <?php echo form_textarea( array(
                'name' => 'address',
                'value' => set_value( 'address', show_data( @$accepted->address), false ),
                'class' => 'form-control form-control-sm',
          ...
          <?php if (  @$accepted->lat !='0' && @$accepted->lng !='0' ):?>
          <div class="col-md-6">
            <div id="accepted_map" style="width: 100%; height: 400px;"></div>
            ...
            <div class="form-group">
              ...
              <?php
                echo form_input( array(
                  ...
                  'class' => 'form-control',
                  'placeholder' => '',
                  'value' => set_value( 'lat', show_data( @$accepted->lat ), false ),
                  'readonly' => 'true'
                ));
              ?>
            </div>
            <div class="form-group">
              ...
              <?php
                echo form_input( array(
                  ...
                  'class' => 'form-control',
                  'placeholder' => '',
                  'value' =>  set_value( 'lat', show_data( @$accepted->lng ), false ),
                  'readonly' => 'true'
                ));
              ?>
            </div>
        ...
        <div>
                <h3>Bank Slip</h3>
                <?php   if($accepted->slip_url) {  ?>
                <img src="<?php echo base_url().$accepted->slip_url  ?>" style="width:400px" alt="">
                <?php }else{?>
        ...
        <div class="form-group" style="background-color: #edbbbb; padding: 20px;">
          ...
          <select id="item_is_published" name="item_is_published" class="form-control">
             <option value="1" <?php if($accepted->status == '1')echo("selected")?> >Approved</option>
             <option value="2" <?php if($accepted->status == '2')echo("selected")?> >Disable</option>
             <option value="3" <?php if($accepted->status == '3')echo("selected")?> >Reject</option>
          </select>
        </div>
      </div>
        ...
        <div class="gallery" id="gallery" style="margin-left: 15px; margin-bottom: 15px;">
          <?php
              $conds = array( 'img_type' => 'item', 'img_parent_id' => $accepted->id );
