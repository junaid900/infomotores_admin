...
<section class="content animated fadeInRight">
  ...
  <div class="card card-info">
    ...
    <div class='d-flex justify-content-center'>
        <h1 ><span class='badge badge-danger'>Item # - <?php $reject->item_no ?></span></h1>
    </div>
    <form role="form">
      <div class="card-body">
      	<div class="row">
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'title',
                'value' => set_value( 'title', empty(show_data( @$reject->title))? 'No Title' :show_data( @$reject->title)),
...
<!--Color-->
            ...
            <?php if ($reject->manufacturer_id != "-2" && $reject->color_id != null): ?>
...
<?php 
               ...
               $colorData = $this->db->get_where('bs_items_colors', array('status' => 1))->result();
                ...
                echo form_dropdown(
                  'color_value',
                  $options,
                  set_value( 'color_value', show_data( @$reject->color_id), false ),
            ...
            //   )); 
             ...
             $transdata = $this->db->get_where('bs_items_transmissions', array('status' => 1)) ->result();
                ...
                echo form_dropdown(
                  'transmissions',
                  $options,
                  set_value( 'transmissions', show_data( @$reject->transmission_id), false ),
                  'class="form-control form-control-sm mr-3"
                  id="transmissions"'
                );
            ...
            <?php if ($reject->manufacturer_id != "-2"): ?>
            ...
            <div class="form-group">
              ...
              <?php
              if($reject->manufacturer_id==-1){
                  echo "<br>";
                  echo "<p>" . $reject->manufacturer_name . "</p>";
              } 
              else{
                  $options=array();
                $conds['status'] = 1;
        ...
        //   && $reject->item_type_id != null
            ...
            <div class="form-group">
             ...
             <?php if ($reject->description != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
            ...
            <?php if ($reject->highlight_info != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
            ...
            <div class="form-group">
              ...
              <?php   if( $reject->package_detail){ ?>
              <div style="font-size:16px;"><?php

               $data_get =  json_decode(htmlspecialchars_decode($reject->package_detail));
               if(!empty($data_get)){
        ...
        <input type="datetime-local" class="form-control" name="expiry_date" required value="<?php echo isset($reject->expiry_date) ?
        // set_value(
        $reject->expiry_date
        // , date('Y-m-d', strtotime($reject->expiry_date)))
        : set_value('expiry_date'); ?>">
          ...
          <div class="col-md-6">
            ...
            <?php if ($reject->engine_power != null || true): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
              ...
              <?php echo form_input( array(
                'name' => 'power',
                'value' => set_value( 'power', show_data( @$reject->engine_power), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($reject->item_price_type_id != null  || true): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
            ...
            <?php if ($reject->item_currency_id != null || true): ?>
            <!-- <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
            ...
            <?php if ($reject->plate_number != null || true): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
                Number Plate
              </label>
              ...
              <?php echo form_input( array(
                'name' => 'plate_number',
                'value' => set_value( 'plate_number', show_data( @$reject->plate_number), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'mileage',
                'value' => set_value( 'mileage', show_data( @$reject->mileage), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($reject->fuel_type_id != null || true): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
               Fuel Type
              </label>
              <?php
            //  $data = $this->db->get_where('bs_items_fuel_types', array('id' => $reject->fuel_type_id)) ->result();
              ...
              <?php 
               ...
               $options=array();;
                ...
                echo form_dropdown(
                  'fuel_type_id',
                  $options,
                  set_value( 'fuel_type_id', show_data( @$reject->fuel_type_id), false ),
            ...
            <div class="form-group">
              ...
              echo form_input( array(
                'name' => 'sell_type',
                'value' => set_value( 'sell_type', show_data( @$reject->sell_type), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($reject->manufacturer_id != "-2" && $reject->year != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
                Year
              </label>
              ...
              <?php echo form_input( array(
                'name' => 'year',
                'value' => set_value( 'year', show_data( @$reject->year), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($reject->manufacturer_id == "-2" && $reject->service_area != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
                Service Area:
              </label>

                <p><?php echo $reject->service_area; ?></p>
          ...
          <!-- <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <?php   if( $reject->phone_number){ ?>
              <h2 style="color:red;"><?php  echo  $reject->phone_number ?></h2>
               <?php  }else{ ?>
                <h3 style="color:red;">Not Avialable</h3>
               <?php } ?>
            </div>
        ...
        <?php if ($reject->manufacturer_id != "-2"): ?>
          ...
          <?php endif ?>
            ...
            <?php if ($reject->address != null || true): ?>
        ...
        <div>
                <h3>Bank Slip</h3>
                <?php   if($reject->slip_url) {  ?>
                <img src="<?php echo base_url().$reject->slip_url  ?>" style="width:400px" alt="">
                <?php }else{?>
        ...
        <div class="form-group" style="background-color: #edbbbb; padding: 20px;">
          ...
          <select id="item_is_published" name="item_is_published" class="form-control">
             <option value="1" <?php if($reject->status == '1')echo("selected")?> >Approved</option>
             <option value="2" <?php if($reject->status == '2')echo("selected")?> >Disable</option>
             <option value="3" <?php if($reject->status == '3')echo("selected")?> >Reject</option>
          </select>
        </div>
      </div>
