      	...
      	<div class="row">
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'title',
                'value' => set_value( 'title', empty(show_data( @$pending->title))? 'No Title' :show_data( @$pending->title)),
...
<!--Color-->
            ...
            <?php if ($pending->manufacturer_id != "-2" && $pending->color_id != null): ?>
...
<?php
               ...
               $colorData = $this->db->get_where('bs_items_colors', array('status' => 1))->result();
                ...
                echo form_dropdown(
                  'color_value',
                  $options,
                  set_value( 'color_value', show_data( @$pending->color_id), false ),
            ...
            //   ));
             ...
             $transdata = $this->db->get_where('bs_items_transmissions', array('status' => 1)) ->result();
                ...
                echo form_dropdown(
                  'transmissions',
                  $options,
                  set_value( 'transmissions', show_data( @$pending->transmission_id), false ),
                  'class="form-control form-control-sm mr-3"
                  id="transmissions"'
                );
            ...
            <?php if ($pending->manufacturer_id != "-2"): ?>
            ...
            <div class="form-group">
              ...
              <?php
              if($pending->manufacturer_id==-1){
                  echo "<br>";
                  echo "<p>" . $pending->manufacturer_name . "</p>";
              }
              else{
                $options=array();
                $conds['status'] = 1;
                $conds['category_id'] = $pending->category_id;
           ...
           <?php if ($pending->manufacturer_id != "-2"): ?>
            ...
            <div class="form-group">
             ...
             <?php if ($pending->description != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
            ...
            <?php if ($pending->highlight_info != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
            ...
            <div class="form-group">
              ...
              <?php   if( $pending->package_detail){ ?>
              <div style="font-size:16px;"><?php

               $data_get =  json_decode(htmlspecialchars_decode($pending->package_detail));
               if(!empty($data_get)){
        ...
        <input type="datetime-local" class="form-control" name="expiry_date" required value="<?php echo isset($pending->expiry_date) ?
        // set_value(
        $pending->expiry_date
        // , date('Y-m-d', strtotime($pending->expiry_date)))
        ...
        <!--Form  Right Side-->
          <div class="col-md-6">
            ...
            <?php if ($pending->engine_power != null || true): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
              ...
              <?php echo form_input( array(
                'name' => 'power',
                'value' => set_value( 'power', show_data( @$pending->engine_power), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($pending->item_currency_id != null || true): ?>
            <!-- <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
            ...
            <?php if ($pending->plate_number != null || true): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
                Number Plate
              </label>
              ...
              <?php echo form_input( array(
                'name' => 'plate_number',
                'value' => set_value( 'plate_number', show_data( @$pending->plate_number), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'mileage',
                'value' => set_value( 'mileage', show_data( @$pending->mileage), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($pending->fuel_type_id != null || true): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
               Fuel Type
              </label>
              <?php
            //  $data = $this->db->get_where('bs_items_fuel_types', array('id' => $pending->fuel_type_id)) ->result();
              ...
              <?php
               ...
               $options=array();;
                ...
                echo form_dropdown(
                  'fuel_type_id',
                  $options,
                  set_value( 'fuel_type_id', show_data( @$pending->fuel_type_id), false ),
            ...
            <div class="form-group">
              ...
              echo form_input( array(
                'name' => 'sell_type',
                'value' => set_value( 'sell_type', show_data( @$pending->sell_type), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($pending->manufacturer_id != "-2" && $pending->year != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
                Year
              </label>
              ...
              <?php echo form_input( array(
                'name' => 'year',
                'value' => set_value( 'year', show_data( @$pending->year), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($pending->manufacturer_id == "-2" && $pending->service_area != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
                Service Area:
              </label>

                <p><?php echo $pending->service_area; ?></p>
            ...
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <?php   if( $pending->phone_number){ ?>
                  <h2 style="color:red;"><?php  echo  $pending->phone_number ?></h2>
                   <?php  }else{ ?>
                    <h3 style="color:red;">Not Avialable</h3>
                   <?php } ?>
                </div>
            </div>
            <?php if(!empty($pending->second_phone_numeber)): ?>
                <div class="col-md-6">
                    <div class="form-group">
                      <label> <span style="font-size: 17px; color: red;">*</span>
                      <?php echo get_msg('Second Phone Number')?>
                      </label>
                      <?php   if( $pending->phone_number){ ?>
                      <h2 style="color:red;"><?php  echo  $pending->phone_number ?></h2>
                       <?php  }else{ ?>
        ...
        <!--  <div class="col-md-6">
          ...
          <?php endif ?>
            ...
            <?php if ($pending->address != null || true): ?>
        ...
        <div>
                <h3>Bank Slip</h3>
                <?php   if($pending->slip_url) {  ?>
                <img src="<?php echo base_url().$pending->slip_url  ?>" style="width:400px" alt="">
                <?php }else{?>
        ...
        <div class="form-group" style="background-color: #edbbbb; padding: 20px;">
          ...
          <select id="item_is_published" name="item_is_published" class="form-control">
             <option value="1" <?php if($pending->status == '1')echo("selected")?> >Approved</option>
             <option value="2" <?php if($pending->status == '2')echo("selected")?> >Disable</option>
             <option value="3" <?php if($pending->status == '3')echo("selected")?> >Reject</option>
          </select>
        </div>
      </div>
