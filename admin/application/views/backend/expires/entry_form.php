<?php
	$attributes = array( 'id' => 'expire-form', 'enctype' => 'multipart/form-data');
...
<section class="content animated fadeInRight">
  ...
  <div class="card card-info">
    ...
    <div class='d-flex justify-content-center'>
        <h1 ><span class='badge badge-danger'>Item # - <?= $expire->item_no ?></span></h1>
    </div>
    <form role="form">
      <div class="card-body">
      	<div class="row">
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'title',
                'value' => set_value( 'title', empty(show_data( @$expire->title))? 'No Title' :show_data( @$expire->title)),
...
<!--Color-->
            ...
            <?php if ($expire->manufacturer_id != "-2" && $expire->color_id != null): ?>
...
<?php 
               ...
               $colorData = $this->db->get_where('bs_items_colors', array('status' => 1))->result();
                ...
                echo form_dropdown(
                  'color_value',
                  $options,
                  set_value( 'color_value', show_data( @$expire->color_id), false ),
            ...
            //   )); 
             ...
             $transdata = $this->db->get_where('bs_items_transmissions', array('status' => 1)) ->result();
                ...
                echo form_dropdown(
                  'transmissions',
                  $options,
                  set_value( 'transmissions', show_data( @$expire->transmission_id), false ),
                  'class="form-control form-control-sm mr-3"
                  id="transmissions"'
                );
            ...
            <?php if ($expire->manufacturer_id != "-2"): ?>
            ...
            <div class="form-group">
              ...
              <?php
              if($expire->manufacturer_id==-1){
                  echo "<br>";
                  echo "<p>" . $expire->manufacturer_name . "</p>";
              } 
              else{
                  $options=array();
                $conds['status'] = 1;
                ...
                echo form_dropdown(
                  'manufacturer_id',
                  $options,
                  set_value( 'manufacturer_id', show_data( @$expire->manufacturer_id), false ),
                  'class="form-control form-control-sm mr-3" 
              ...
              <?php
                if(isset($expire)) {
                    if($expire->model_id==-1){
                         echo "<br>";
                  echo "<p>" . $expire->model_name . "</p>";
                    }else{
                        $options=array();
                   $options[0]=get_msg('select_model');
                  $conds['manufacturer_id'] = $expire->manufacturer_id;
                  ...
                  echo form_dropdown(
                    'model_id',
                    $options,
                    set_value( 'model_id', show_data( @$expire->model_id), false ),
        ...
        //   && $expire->item_type_id != null
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_type_id',
                  $options,
                  set_value( 'item_type_id', show_data( @$expire->item_type_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_location_id',
                  $options,
                  set_value( 'item_location_id', show_data( @$expire->item_location_id), false ),
             ...
             <?php if ($expire->description != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
              ...
              <?php echo form_textarea( array(
                'name' => 'description',
                'value' => set_value( 'description', show_data( @$expire->description), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($expire->highlight_info != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
              ...
              <?php echo form_textarea( array(
                'name' => 'highlight_info',
                'value' => set_value( 'info', show_data( @$expire->highlight_info), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php   if( $expire->package_detail){ ?>
              <div style="font-size:16px;"><?php

               $data_get =  json_decode(htmlspecialchars_decode($expire->package_detail));
               if(!empty($data_get)){
        ...
        <input type="datetime-local" class="form-control" name="expiry_date" required value="<?php echo isset($expire->expiry_date) ?
        // set_value(
        $expire->expiry_date
        // , date('Y-m-d', strtotime($expire->expiry_date)))
        : set_value('expiry_date'); ?>">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'price',
                'value' => set_value( 'price', show_data( @$expire->price), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($expire->engine_power != null || true): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
              ...
              <?php echo form_input( array(
                'name' => 'power',
                'value' => set_value( 'power', show_data( @$expire->engine_power), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($expire->item_price_type_id != null  || true): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_price_type_id',
                  $options,
                  set_value( 'item_price_type_id', show_data( @$expire->item_price_type_id), false ),
            ...
            <?php if ($expire->item_currency_id != null || true): ?>
            <!-- <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_currency_id',
                  $options,
                  set_value( 'item_currency_id', show_data( @$expire->item_currency_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  ...
                  $options,
                  set_value( 'condition_of_item_id', show_data( @$expire->condition_of_item_id), false ),
            ...
            <?php if ($expire->plate_number != null || true): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
                Number Plate
              </label>
              ...
              <?php echo form_input( array(
                'name' => 'plate_number',
                'value' => set_value( 'plate_number', show_data( @$expire->plate_number), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'mileage',
                'value' => set_value( 'mileage', show_data( @$expire->mileage), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($expire->fuel_type_id != null || true): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
               Fuel Type
              </label>
              <?php
            //  $data = $this->db->get_where('bs_items_fuel_types', array('id' => $expire->fuel_type_id)) ->result();
              ...
              <?php 
               ...
               $options=array();;
                ...
                echo form_dropdown(
                  'fuel_type_id',
                  $options,
                  set_value( 'fuel_type_id', show_data( @$expire->fuel_type_id), false ),
            ...
            <div class="form-group">
              ...
              echo form_input( array(
                'name' => 'sell_type',
                'value' => set_value( 'sell_type', show_data( @$expire->sell_type), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($expire->manufacturer_id != "-2" && $expire->year != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
                Year
              </label>
              ...
              <?php echo form_input( array(
                'name' => 'year',
                'value' => set_value( 'year', show_data( @$expire->year), false ),
                'class' => 'form-control form-control-sm',
            ...
            <?php if ($expire->manufacturer_id == "-2" && $expire->service_area != null): ?>
            <div class="form-group">
              <label> <span style="font-size: 17px; color: red;">*</span>
                Service Area:
              </label>

                <p><?php echo $expire->service_area; ?></p>
          ...
          <!-- <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'brand',
                'value' => set_value( 'brand', show_data( @$expire->brand), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php   if( $expire->phone_number){ ?>
              <h2 style="color:red;"><?php  echo  $expire->phone_number ?></h2>
               <?php  }else{ ?>
                <h3 style="color:red;">Not Avialable</h3>
               <?php } ?>
            </div>
        ...
        <?php if ($expire->manufacturer_id != "-2"): ?>
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                <?php echo form_checkbox( array(
                  ...
                  'id' => 'business_mode',
                  'value' => 'accept',
                  'checked' => set_checkbox('business_mode', 1, ( @$expire->business_mode == 1 )? true: false ),
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                <?php echo form_checkbox( array(
                  ...
                  'id' => 'is_sold_out',
                  'value' => 'accept',
                  'checked' => set_checkbox('is_sold_out', 1, ( @$expire->is_sold_out == 1 )? true: false ),
                  'class' => 'form-check-input',
                  'onclick' => 'return false'
                )); ?>
          ...
          <?php endif ?>
            ...
            <?php if ($expire->address != null || true): ?>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <?php echo form_textarea( array(
                'name' => 'address',
                'value' => set_value( 'address', show_data( @$expire->address), false ),
                'class' => 'form-control form-control-sm',
          ...
          <?php if (  @$expire->lat !='0' && @$expire->lng !='0' ):?>
          <div class="col-md-6">
            <div id="expire_map" style="width: 100%; height: 400px;"></div>
            ...
            <div class="form-group">
              ...
              <?php
                echo form_input( array(
                  ...
                  'class' => 'form-control',
                  'placeholder' => '',
                  'value' => set_value( 'lat', show_data( @$expire->lat ), false ),
                  'readonly' => 'true'
                ));
              ?>
            </div>
            <div class="form-group">
              ...
              <?php
                echo form_input( array(
                  ...
                  'class' => 'form-control',
                  'placeholder' => '',
                  'value' =>  set_value( 'lat', show_data( @$expire->lng ), false ),
                  'readonly' => 'true'
                ));
              ?>
            </div>
        ...
        <div>
                <h3>Bank Slip</h3>
                <?php   if($expire->slip_url) {  ?>
                <img src="<?php echo base_url().$expire->slip_url  ?>" style="width:400px" alt="">
                <?php }else{?>
        ...
        <div class="form-group" style="background-color: #edbbbb; padding: 20px;">
          ...
          <select id="item_is_published" name="item_is_published" class="form-control">
             <option value="1" <?php if($expire->status == '1')echo("selected")?> >Approved</option>
             <option value="2" <?php if($expire->status == '2')echo("selected")?> >Disable</option>
             <option value="3" <?php if($expire->status == '3')echo("selected")?> >Reject</option>
          </select>
        </div>
      </div>
        ...
        <div class="gallery" id="gallery" style="margin-left: 15px; margin-bottom: 15px;">
          <?php
              $conds = array( 'img_type' => 'item', 'img_parent_id' => $expire->id );
