...
//                  print_r($_REQUEST);
        ...
        // echo '_parse_' . $this->request->method;
...
// echo "x";
    ...
    public function response($data = null, $http_code = null, $continue = false)
    {
        ...
        // echo $output;
        // var_dump('Content-Type: '.$this->_supported_formats[$this->response->format] . '; charset=' . strtolower($this->config->item('charset')));
    ...
    protected function _parse_post()
    {
        ...
        // echo  $this->request->format and

        // echo $this->request->format and $this->request->body = file_get_contents('php://input');
    }
